...
def write_14():
    contador.goto(0,200)
    contador.write("¡Feliz 14 de Febrero karlita <3 !", align="center", font=("Courier", 25 //2, "bold"))
    time.sleep(1)
